...
3. Analyses historical race data to identify general trends, performance patterns, and race-specific insights using Python libraries like Pandas and Matplotlib.
...
7. Provides race-by-race predictions for specific F1 seasons and visualises actual vs. predicted winners using heatmaps.
